...
class TunerFrame(QFrame):
    ...
    def __init__(self, *args):
        ...
        self.frequencySlider = Qwt.QwtSlider(
            self, Qt.Horizontal, Qwt.QwtSlider.TopScale)
    ...
    def adjustFreq(self, f):
        ...
        self.emit(SIGNAL("fieldChanged(double)"), field)	
...
class Knob(QWidget):
    ...
    def sizeHint(self):
        ...
        off = self.knob.scaleDraw().extent(QPen(), self.knob.font())
        off -= 10 # spacing
...
class RadioDemo(QWidget):
    ...
    def __init__(self, *args):
        ...
        tunerFrame.setFrameStyle(QFrame.Panel | QFrame.Raised)

        amplifierFrame = AmplifierFrame(self)
        amplifierFrame.setFrameStyle(QFrame.Panel | QFrame.Raised)
