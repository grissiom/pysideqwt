...
class BodeDemo(QMainWindow):
    ...
    def __init__(self, *args):
        ...
        self.setContextMenuPolicy(NoContextMenu)
        ...
        zoomer = QwtPlotZoomer(
            ...
            QwtPicker.AlwaysOff,
            self.plot.canvas())
        zoomer.setRubberBandPen(QPen(green))
        ...
        self.picker = QwtPlotPicker(
            ...
            QwtPicker.AlwaysOn,
            self.plot.canvas())
        self.picker.setRubberBandPen(QPen(green))
        self.picker.setTrackerPen(QPen(cyan))
        ...
        btnZoom.setToolButtonStyle(ToolButtonTextUnderIcon)
        toolBar.addWidget(btnZoom)

        btnPrint = QToolButton(toolBar)
        btnPrint.setText("Print")
        btnPrint.setIcon(QIcon(QPixmap(print_xpm)))
        btnPrint.setToolButtonStyle(ToolButtonTextUnderIcon)
        ...
        if QT_VERSION >= 0X040100:
            ...
            btnPDF.setToolButtonStyle(ToolButtonTextUnderIcon)
        ...
        if QT_VERSION >= 0x040300:
            ...
            btnSVG.setToolButtonStyle(ToolButtonTextUnderIcon)
